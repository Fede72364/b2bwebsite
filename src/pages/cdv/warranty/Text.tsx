...
const Text = () => (
    <>
        ...
        <span className={paragraphStyle}>
            Solicita una asesoría gratuita con uno de nuestros instructores, para que podamos evaluar el funcionamiento de tu metodología de ventas actual y cómo optimizarlo.
        </span>
        <span className={paragraphStyle}>
